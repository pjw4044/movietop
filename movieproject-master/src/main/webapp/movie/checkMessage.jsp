...
<jsp:useBean id="mgr" class="movie.MessageMgr"/>
<%
...
totalRecord = mgr.getTotalCount(userId);
...
<table>
	<tr> 
		...
		<%
				...
				mgr.getBoardList(userId, start, cnt);
...
function deleteMessage() {
	 var checkboxes = document.getElementsByName("deletebox[]");
	  ...
	  $.ajax({
		    url: "/myapp/movieProject/messageDeleteServlet",
		    type: "POST",
