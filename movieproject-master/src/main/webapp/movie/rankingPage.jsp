		...
		<div>
			<div>
				...
				<div class="rankList_container rounded  border  border-light border-3" >
					...
					%>
							<li class="col rank_li"><div class="movie_div" ><a href="movieDetail.jsp?title=<%= rankBean.getTitle()%>">
					...
					<!-- ott  -->
						...
						%>
							<li>
							<!-- @@넷플릭스 포스터 타이틀 -->
								<div class="movie_div" ><a href="movieDetail.jsp?title=<%=netfBean.getTitle() %>">
