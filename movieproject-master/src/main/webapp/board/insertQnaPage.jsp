...
<br/>
<form name="postFrm" method="post" action="insertQna" 
	...
	<tr>
		...
		<table align="center">
			...
			<tr>
				<td>공개여부</td>
				<td>
				<input type="checkbox" name="ISSECRET" value="true">비공개</td>
			</tr>
			<tr>
				<td>내 용</td>
			...
			<tr>
				<td colspan="2">
					 ...
					 <input type="button" value="리스트" onClick="javascript:location.href='qnaBoardPage.jsp'">
				</td>
			</tr>
		</table>
		</td>
