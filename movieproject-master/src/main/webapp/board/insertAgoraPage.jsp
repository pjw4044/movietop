...
<%
	...
	if(request.getParameter("movieIdx")!=null){
		movieIdx = UtilMgr.parseInt(request, "movieIdx");
	}
%>
    <meta charset="UTF-8">
...
<br/>
<form name="postFrm" method="post" action="insertAgora" 
		...
		<table align="center">
			...
			<tr>
				<td colspan="2">
					 ...
					 <input type="button" value="리스트" onClick="javascript:location.href='agoraBoardPage.jsp'">
				</td>
			</tr>
		</table>
		</td>
